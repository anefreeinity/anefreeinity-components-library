...
const Snackbar: React.FC<SnackbarProps> = ({
  ...
  ${property.SnackbarPosition} transform -translate-x-1/2 max-w-sm md:max-w-md lg:max-w-lg w-3/4 md:w-auto pr-4 ${
      title ? 'pl-3' : 'pl-2'
  } py-2 ${property.SnackbarBackgroundColor} ${property.SnackbarBorderRadius} ${property.SnackbarShadow} flex items-center justify-between transition-all ${
